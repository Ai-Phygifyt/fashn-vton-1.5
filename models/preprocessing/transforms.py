...
class AspectPreserveResize:
    ...
    def _get_or_infer_scale_factor(self, width: int, height: int, allow_upsampling: bool = True) -> float:
    ...
    def _resize_image_opencv(
        ...
        interpolation = _default(interpolation, cv2.INTER_LANCZOS4 if scale_factor > 1 else cv2.INTER_AREA)
