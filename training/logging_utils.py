...
class TrainLogger:
    ...
    def log_step(
        self, step: int, epoch: int, loss: float, lr: float, extra: Optional[Dict[str, Any]] = None
    ) -> None:
        dt = self.eta.tick()
        ...
        msg = (
            f"epoch {epoch} | step {step}/{self.total_steps} | "
        ...
        self.scalars(
            ...
            **{
                "train/loss": loss,
                "train/loss_avg": self.tracker.mean("loss"),
                "train/lr": lr,
