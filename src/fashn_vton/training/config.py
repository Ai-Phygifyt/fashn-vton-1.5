...
LORA_PRESETS: Dict[str, List[str]] = {
    ...
    "attention_mlp": ["qkv", "proj", "linear1", "linear2", "img_mlp.0", "img_mlp.2", "txt_mlp.0", "txt_mlp.2"],
    ...
    "attention_mlp_mod": ["qkv", "proj", "linear1", "linear2", "img_mlp.0", "img_mlp.2",
                          "txt_mlp.0", "txt_mlp.2", "lin"],
}
...
class LoRAConfig:
    ...
    include_blocks: List[str] = field(default_factory=lambda: ["double_blocks", "single_blocks", "x_patch_mixer"])
